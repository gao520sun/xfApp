...
import {getSongAuthorPoetry} from '../Api/SongApi';

interface SAuthorPoetryPageContainerProps {}

const SAuthorPoetryPageContainer = (props: SAuthorPoetryPageContainerProps) => {
    ...
    const fetchData = async ({offset,successCallback,errorCallback}) => {
        ...
        const res = await getSongAuthorPoetry({limit:10, offset:offset, author: params['author']})
        if(res.status === 1) {
...
SAuthorPoetryPageContainer.navigationOptions = ({navigation}) => ({
    title:navigation.state.params.title,
  })

export default SAuthorPoetryPageContainer;
